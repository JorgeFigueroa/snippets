...
alt + click =     #para hacer una multiselecion
cmd + alt + t =   #seleciono codigo y pongo una etiqueta
cmd + alt + l =   #para reformatear el codigo
cmd + l   #goto line
cmd + .      =    #para cerrar una parte de codigo
